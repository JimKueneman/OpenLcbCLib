...
const CL_MAIN_NODES = [
  ...
  },
  {
    ...
    h:        CL.nodeH,
    desc:     'Top-level entry point called by main(). Calls initialize_hardware() DI, then calls Bootloader_init(). If jump_to_application() succeeds inside Bootloader_init(), this function never returns to its caller.',
    file:     'bootloader.c',
    line:     169,
  },
  {
