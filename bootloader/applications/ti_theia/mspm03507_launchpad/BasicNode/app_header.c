 ...
 *          linker section, which @c device_linker.cmd forces to address
 *          @c APP_HEADER_ADDRESS = 0x00003CC0
 ...
 *
 * Placed by the linker at 0x00003CC0.  All checksum fields are zero;
 * a post-link tool must patch them before production programming.
 * ------------------------------------------------------------------------- */

/**
 * @brief Application image header placed at @c APP_HEADER_ADDRESS (0x00003CC0).
 *
