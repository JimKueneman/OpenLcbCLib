...
node_parameters_t _node_parameters_main_node = {
    ...
    .address_space_all.highest_address = 0x00,
...
TEST(ProtocolConfigMemReadHandler, memory_read_request_all)
{
...
TEST(ProtocolConfigMemReadHandler, memory_read_request_config_mem)
{
