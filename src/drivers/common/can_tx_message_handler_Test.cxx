...
void _application_callback_tx(void)
{
...
TEST(CanTxMessageHandler, handle_can_frame)
{
    ...
    EXPECT_TRUE(CanTxMessageHandler_handle_can_frame(&can_msg));
    ...
    EXPECT_FALSE(CanTxMessageHandler_handle_can_frame(&can_msg));
...
TEST(CanTxMessageHandler, handle_stream_frame)
{
    ...
    EXPECT_TRUE(CanTxMessageHandler_handle_stream_frame(openlcb_msg, &can_msg, 0));
...
TEST(CanTxMessageHandler, handle_datagram_frame)
{
    ...
    while (offset < openlcb_msg->payload_count)
    {
        ...
        EXPECT_TRUE(CanTxMessageHandler_handle_datagram_frame(openlcb_msg, &can_msg, &offset));
    ...
    while (offset < openlcb_msg->payload_count)
    {
        ...
        {
            counter++;
            EXPECT_FALSE(CanTxMessageHandler_handle_datagram_frame(openlcb_msg, &can_msg, &offset));
        }
    }
...
TEST(CanTxMessageHandler, handle_addressed_msg_frame)
{
    ...
    while (offset < openlcb_msg->payload_count)
    {
        ...
        EXPECT_TRUE(CanTxMessageHandler_handle_addressed_msg_frame(openlcb_msg, &can_msg, &offset));
        EXPECT_TRUE(application_callback_tx_called);
        application_callback_tx_called = false;
    }
    ...
    while (offset < openlcb_msg->payload_count)
    {
        ...
        {
            counter++;
            EXPECT_FALSE(CanTxMessageHandler_handle_addressed_msg_frame(openlcb_msg, &can_msg, &offset));
        }
    }
...
TEST(CanTxMessageHandler, unaddressed_msg_frame)
{
    ...
    while (offset < openlcb_msg->payload_count)
    {
        ...
        EXPECT_TRUE(CanTxMessageHandler_handle_unaddressed_msg_frame(openlcb_msg, &can_msg, &offset));
        EXPECT_TRUE(application_callback_tx_called);
        application_callback_tx_called = false;
    }
