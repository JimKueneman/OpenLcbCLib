...
bool try_transmit_openlcb_message(openlcb_msg_t *openlcb_msg)
{
    ...
    _try_transmit_openlcb_msg_called = true;
...
{
    _try_transmit_can_msg_called = true;
...
TEST(CanLoginMessageHandler, transmit_cid07)
{
...
TEST(CanLoginMessageHandler, transmit_cid06)
{
...
TEST(CanLoginMessageHandler, transmit_cid05)
{
...
TEST(CanLoginMessageHandler, transmit_cid04)
{
...
TEST(CanLoginMessageHandler, transmit_rid)
{
...
TEST(CanLoginMessageHandler, transmit_amd)
{
...
TEST(CanLoginMessageHandler, initialization_complete)
{
...
#define ALIAS 0xAAA
    ...
    EXPECT_EQ(_try_transmit_openlcb_msg->payload_count, 6);
    EXPECT_EQ(_try_transmit_openlcb_msg->source_alias, ALIAS);
    EXPECT_EQ(_try_transmit_openlcb_msg->source_id, NODE_ID);
    EXPECT_EQ(OpenLcbUtilities_extract_node_id_from_openlcb_payload(_try_transmit_openlcb_msg, 0), NODE_ID);
...
TEST(CanLoginMessageHandler, transmit_producer_events)
{
...
#define ALIAS 0xAAA
    ...
    // *******************************************************************************************
    // Test with the transmit buffer free and get all events
    // *******************************************************************************************
    _try_transmit_openlcb_msg_enabled = true;
...
TEST(CanLoginMessageHandler, transmit_consumer_events)
{
