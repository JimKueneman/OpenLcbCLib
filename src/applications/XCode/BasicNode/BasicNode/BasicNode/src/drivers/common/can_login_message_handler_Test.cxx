...
#define NODE_ALIAS 0xAAA
    ...
    can_statemachine_info.openlcb_node->alias = NODE_ALIAS;

    CanLoginMessageHandler_load_cid07(&can_statemachine_info);

    EXPECT_EQ(can_statemachine_info.outgoing_can_msg->payload_count, 0);
    EXPECT_EQ(can_statemachine_info.outgoing_can_msg->identifier, RESERVED_TOP_BIT | CAN_CONTROL_FRAME_CID7 | (((can_statemachine_info.openlcb_node->id >> 24) & 0xFFF000) | can_statemachine_info.openlcb_node->alias));
...
#define NODE_ID 0x010203040506
    ...
    EXPECT_EQ(can_statemachine_info.outgoing_can_msg->payload_count, 0);
    EXPECT_EQ(can_statemachine_info.outgoing_can_msg->identifier, RESERVED_TOP_BIT | CAN_CONTROL_FRAME_CID6 | (((can_statemachine_info.openlcb_node->id >> 12) & 0xFFF000) | can_statemachine_info.openlcb_node->alias));
...
#define NODE_ID 0x010203040506
    ...
    EXPECT_EQ(can_statemachine_info.outgoing_can_msg->payload_count, 0);
    EXPECT_EQ(can_statemachine_info.outgoing_can_msg->identifier, RESERVED_TOP_BIT | CAN_CONTROL_FRAME_CID5 | ((can_statemachine_info.openlcb_node->id & 0xFFF000) | can_statemachine_info.openlcb_node->alias));
...
#define NODE_ID 0x010203040506
    ...
    EXPECT_EQ(can_statemachine_info.outgoing_can_msg->payload_count, 0);
    EXPECT_EQ(can_statemachine_info.outgoing_can_msg->identifier, RESERVED_TOP_BIT | CAN_CONTROL_FRAME_CID4 | (((can_statemachine_info.openlcb_node->id << 12) & 0xFFF000) | can_statemachine_info.openlcb_node->alias));
...
#define NODE_ID 0x010203040506
    ...
    EXPECT_EQ(can_statemachine_info.outgoing_can_msg->payload_count, 0);
    EXPECT_EQ(can_statemachine_info.outgoing_can_msg->identifier, (RESERVED_TOP_BIT | CAN_CONTROL_FRAME_RID | can_statemachine_info.openlcb_node->alias));
...
#define NODE_ID 0x010203040506
    ...
    EXPECT_EQ(can_statemachine_info.outgoing_can_msg->payload_count, 6);
    EXPECT_EQ(CanUtilities_extract_can_payload_as_node_id(can_statemachine_info.outgoing_can_msg), NODE_ID);
    EXPECT_EQ(can_statemachine_info.outgoing_can_msg->identifier, (RESERVED_TOP_BIT | CAN_CONTROL_FRAME_AMD | can_statemachine_info.openlcb_node->alias));
    EXPECT_FALSE(can_statemachine_info.openlcb_node->state.initalized);
...
#define ALIAS 0xAAA
    ...
    EXPECT_EQ(can_statemachine_info.outgoing_openlcb_msg->mti, MTI_INITIALIZATION_COMPLETE);
    EXPECT_EQ(can_statemachine_info.outgoing_openlcb_msg->payload_count, 6);
    EXPECT_EQ(can_statemachine_info.outgoing_openlcb_msg->source_alias, ALIAS);
    EXPECT_EQ(can_statemachine_info.outgoing_openlcb_msg->source_id, NODE_ID);
    EXPECT_EQ(OpenLcbUtilities_extract_node_id_from_openlcb_payload(can_statemachine_info.outgoing_openlcb_msg, 0), NODE_ID);
    ...
    EXPECT_EQ(can_statemachine_info.outgoing_openlcb_msg->mti, MTI_INITIALIZATION_COMPLETE_SIMPLE);
    EXPECT_EQ(can_statemachine_info.outgoing_openlcb_msg->payload_count, 6);
    EXPECT_EQ(can_statemachine_info.outgoing_openlcb_msg->source_alias, ALIAS);
    EXPECT_EQ(can_statemachine_info.outgoing_openlcb_msg->source_id, NODE_ID);
    EXPECT_EQ(OpenLcbUtilities_extract_node_id_from_openlcb_payload(can_statemachine_info.outgoing_openlcb_msg, 0), NODE_ID);
...
#define ALIAS 0xAAA
    ...
    while (can_statemachine_info.openlcb_node->state.run_state == RUNSTATE_LOAD_PRODUCER_EVENTS)
    {
        ...
        EXPECT_EQ(OpenLcbUtilities_extract_event_id_from_openlcb_payload(can_statemachine_info.outgoing_openlcb_msg), (uint64_t)(NODE_ID << 16) + offset);
        offset++;
    }
