...
const node_parameters_t NodeParameters_main_node = {
    ...
    .address_space_configuration_definition.highest_address = 1688, // this is the length of the .cdi file byte array in this initialization structure
    ...
    .address_space_train_function_definition.highest_address = 819, // Length of the FDI file in this structure
