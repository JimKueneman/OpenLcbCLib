...
void print_interrupt(DL_MCAN_IIDX pending_interrupts) {
  ...
  case DL_MCAN_IIDX_WAKEUP:                  printf("DL_MCAN_IIDX_WAKEUP: "); break;
  case DL_MCAN_IIDX_TIMESTAMP_OVERFLOW:      printf("DL_MCAN_IIDX_TIMESTAMP_OVERFLOW: "); break;
  case DL_MCAN_IIDX_DOUBLE_ERROR_DETECTION:  printf("DL_MCAN_IIDX_DOUBLE_ERROR_DETECTION: "); break;
  case DL_MCAN_IIDX_SINGLE_ERROR_CORRECTION: printf("DL_MCAN_IIDX_SINGLE_ERROR_CORRECTION: "); break;
  case DL_MCAN_IIDX_LINE1:                   printf("DL_MCAN_IIDX_LINE1: "); break;
  case DL_MCAN_IIDX_LINE0:                   printf("DL_MCAN_IIDX_LINE0: "); break;
