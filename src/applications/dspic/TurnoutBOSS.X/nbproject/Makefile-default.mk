...
${OBJECTDIR}/turnoutboss_signal_calculations.o: turnoutboss_signal_calculations.c  .generated_files/flags/default/e3386e4c8a6ab7f30a86f85e6f2002b36b8a7b2b .generated_files/flags/default/da39a3ee5e6b4b0d3255bfef95601890afd80709
	@${MKDIR} "${OBJECTDIR}" 
...
${OBJECTDIR}/turnoutboss_signal_calculations.o: turnoutboss_signal_calculations.c  .generated_files/flags/default/93bd1378f6c850acee3b7913e45b9f34647f81a2 .generated_files/flags/default/da39a3ee5e6b4b0d3255bfef95601890afd80709
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/turnoutboss_signal_calculations.o.d 
	@${RM} ${OBJECTDIR}/turnoutboss_signal_calculations.o 
	${MP_CC} $(MP_EXTRA_CC_PRE)  turnoutboss_signal_calculations.c  -o ${OBJECTDIR}/turnoutboss_signal_calculations.o  -c -mcpu=$(MP_PROCESSOR_OPTION)  -MP -MMD -MF "${OBJECTDIR}/turnoutboss_signal_calculations.o.d"      -mno-eds-warn  -g -omf=elf -DSUPPORT_FIRMWARE_BOOTLOADER -DFCY=40000000UL -DXPRJ_default=$(CND_CONF)    $(COMPARISON_BUILD)  -O0 -msmart-io=1 -Wall -msfr-warn=off    -mdfp="${DFP_DIR}/xc16"
