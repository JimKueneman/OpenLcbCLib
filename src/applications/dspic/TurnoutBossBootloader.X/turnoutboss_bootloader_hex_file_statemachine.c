...
#ifdef BOSS2
char* TurnoutBossBootloaderHexFileStateMachine_key = "MustangpeakEngineeringTurnoutBossRevB";
#endif

#ifdef BOSS3
char* TurnoutBossBootloaderHexFileStateMachine_key = "MustangpeakEngineeringTurnoutBossRevC";
#endif
